...
<form name="frm1" method="post" action="studsearchmm.jsp">
<table width="500" >
<tr>
<td width="144">
<input name="b1" type="radio" value="mname" />
MODULE NAME</td>
<td width="170">
<input name="b1" type="radio" value="duration" /> 
DURATION(6m/6w)</td>
</tr>
<tr>
<td colspan="3" >
...
<tr>
  ...
  <td align="center">
  <input name="b1" type="button" value="Search" onclick="xyz()" /></td>
  </tr>
  <tr>
  <td colspan="2">
  <%
