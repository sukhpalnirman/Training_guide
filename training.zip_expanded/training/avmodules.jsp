...
out.print("<tr bgcolor=red><th>ModuleId</th><th>Module name</th><th>Duration</th><th>Description</th><th>Cost</th></tr>");
int ii=1;
		...
		while(rs.next())
		{
			...
			if(ii%2!=0)
			{
			out.println("<tr><td>"+g+"</td><td>"+rs.getString("mname")+"</td><td>"+rs.getString("duration")+"</td><td>"+rs.getString("description")+"</td><td>"+rs.getString("cost")+"</td></tr>");
			}
			else
			{
			out.println("<tr bgcolor=#CCFFFF><td>"+g+"</td><td>"+rs.getString("mname")+"</td><td>"+rs.getString("duration")+"</td><td>"+rs.getString("description")+"</td><td>"+rs.getString("cost")+"</td></tr>");
