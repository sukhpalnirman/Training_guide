...
try
{
	...
	s.execute("update moduled set mname='"+request.getParameter("t1")+"',duration='"+request.getParameter("t2")+"',description='"+request.getParameter("t3")+"',cost='"+request.getParameter("t4")+"' where mid="+request.getParameter("mid"));
con.close();
