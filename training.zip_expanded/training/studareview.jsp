...
ResultSet rs=s.executeQuery("select instid from instd where instname='"+request.getParameter("menu1")+"'");
rs.next();
String uid=rs.getString(1);
rs.close();
s.execute("insert into review(studid,instid,review,rating) values("+session.getAttribute("id")+","+uid+",'"+request.getParameter("t1")+"',"+request.getParameter("t2")+")");
con.close();
response.sendRedirect("studaddreview.jsp?p=1");
	}
	catch(Exception ex)
	{
		out.print("error"+ex);
